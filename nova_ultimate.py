...
if not GROQ_API_KEY:
    raise RuntimeError("GROQ_API_KEY not set. Export it or add it to a .env file.")
    ...
    for turn in range(max_turns):
        ...
        if assistant_message.get("tool_calls"):
            ...
            for tool_call in assistant_message["tool_calls"]:
                ...
                console.print(f"[dim]🔧 Nova is using: {function_name}[/dim]")
                ...
                if tool_result["ok"]:
                    ...
                    console.print(f"[dim]✗ Tool failed[/dim]\n")
...
def main():
    ...
    console.print(Panel.fit(
        "[bold magenta]🌟 NOVA ULTIMATE[/bold magenta]\n"
        "[cyan]Memory • Proactive • Web Browsing • Gemini Vision • Dual Personality[/cyan]\n"
        f"[yellow]{mood}[/yellow]\n"
        "[dim]I remember everything and check in on you 💜[/dim]\n"
    ...
    console.print("[dim]✓ Proactive messaging enabled[/dim]\n")
    ...
    while True:
        try:
            ...
            if user_input.lower() in ['exit', 'quit']:
                console.print("\n[dim]Later, babe! I'll remember everything. 💜[/dim]")
